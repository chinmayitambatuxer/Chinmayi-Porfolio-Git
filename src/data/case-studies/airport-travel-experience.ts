...
export const airportTravelExperience: CaseStudy = {
  ...
  sections: [
    ...
    },
    {
      type: "process",
      id: "ux-process",
      title: "From discovery to validation",
      subtitle:
        "Seven stages — research and framing first, then structure, design, and scenario testing.",
      steps: [
        "Discover — Traveller context and airport pain points",
        "Define — Uncertainty and navigation as the core problem",
        "Map — Journey friction and decision moments",
        "Prioritise — Must-haves vs future opportunities",
        "Structure — Information architecture and user flow",
        "Design — Wireframes to high-fidelity UI",
        "Validate — Scenario testing (see plan below)",
      ],
    },
    {
      type: "gallery",
